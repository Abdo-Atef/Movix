  ...
  return (
    <>
      <section className="py-[45px]">
        ...
        <TrendingSection DATA = {TrendingData} TrendingTab={trendingQuery}/>
        <PopularSection DATA = {PopularData} PopularTab={PopularQuery}/>
        <TopRatedSection DATA = {TopRatedTabData} TopRatedTab={TopRatedTabQuery}/>
      </section>
    </>
  );
}
